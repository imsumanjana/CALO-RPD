...
- Next action: commit the parity correction, then rerun case30/case57 physical audits from that exact clean commit into durable checksum-bound evidence before evaluating memory admission/pressure and soak evidence.
