...
| G2 | Implemented; narrow physical parity retained, pressure/soak proof pending | Shared device lease, 80%-of-free VRAM/RAM admission, CUDA-resident/staged-host/CPU-fallback states and focused regression tests exist. Clean source commit `63f56adb4cf36e15210088eed92ff5325f76b02d` passed bounded physical FP64 CPU/CUDA evaluator parity on the RTX 4060 for development case30 and case57. This is evaluator parity only; physical pressure, staged transfer, fallback, lease, recovery, thermal, and energy qualification remain. |
