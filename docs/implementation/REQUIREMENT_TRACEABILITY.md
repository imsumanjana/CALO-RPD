...
|---|---|---|---|
| Calculate the 80% allowance from memory free/available at admission, not installed capacity | Locally verified; physical parity run recorded live admission samples | `compute/memory_budget.py`, `accelerated/vram_residency.py`, `tests/unit/test_v690_vram_residency.py`, `tests/unit/test_v600_alpha_architecture.py`; clean-commit case30/case57 parity evidence at `63f56ad` recorded peaks below the live 80% allowance | RTX 4060 bounded memory-pressure/recovery trace still required |
