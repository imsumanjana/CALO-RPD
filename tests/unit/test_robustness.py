...
def test_cvar_and_seeded_scenarios():
    assert weighted_cvar([1, 2, 10], [0.4, 0.4, 0.2], 0.8) >= 2
    a = generate_load_scenarios(ScenarioGeneratorConfig(3, 0.1, 0.1), 123)
    b = generate_load_scenarios(ScenarioGeneratorConfig(3, 0.1, 0.1), 123)
