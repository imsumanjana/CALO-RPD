...
- Phase 4 tests must not train/evaluate real policies or open protected cases. Use empty-policy state
  and deterministic temporary synthetic fixtures for lifecycle, migration, deletion, and fallback.
