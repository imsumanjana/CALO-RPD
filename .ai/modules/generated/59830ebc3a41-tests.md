...
- `tests/AGENTS.md`
- `tests/conftest.py`
- `tests/data/AGENTS.md`
- `tests/data/v34_optimizer_seed_snapshots.json`
...
- `tests/unit/test_audit_ci_platform_guard.py`
- `tests/unit/test_audit_ci_project_metadata.py`
- `tests/unit/test_audit_cuda_lease_identity.py`
- `tests/unit/test_audit_device_lease_waiting.py`
- `tests/unit/test_audit_primary_training_failure.py`
...
- `tests/unit/test_calo_methodology_contract.py`
