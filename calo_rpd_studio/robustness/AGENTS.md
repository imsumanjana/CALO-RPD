...
- Freeze scenario/contingency identities and probabilities before confirmatory runs.
- Preserve objective aggregation and report scenario failures and tail behavior.
