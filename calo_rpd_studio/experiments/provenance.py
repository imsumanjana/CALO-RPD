...
def collect_provenance():
    ...
    return {'software_version':'1.0.5','git_commit':_git_commit(),'python_version':platform.python_version(),'platform':platform.platform(),'processor':platform.processor(),'cpu_count':psutil.cpu_count(logical=True),'memory_bytes':psutil.virtual_memory().total,'dependencies':versions}
