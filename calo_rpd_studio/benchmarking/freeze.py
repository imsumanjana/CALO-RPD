...
DEFAULT_FREEZE_RELATIVE_PATHS = (
    ...
    "calo_rpd_studio/compute/xpu_sidecar.py",
    ...
    *,
    ...
    payload = {
        ...
        "frozen_scope": {
            ...
            "v670_xpu_sidecar_fp64_identity_memory_telemetry": True,
            ...
            "v680_xpu_sidecar_live_rediscovery": True,
            "v680_intel_pnp_hardware_tag_detection": True,
            "v680_detected_only_xpu_readiness_visibility": True,
