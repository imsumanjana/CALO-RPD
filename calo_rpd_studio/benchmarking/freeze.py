...
def create_freeze_manifest(
    ...
    *,
    ...
    software_version: str = "3.3.0",
    note: str = "CALO-RPD v3.3 CUDA-resident execution formulation frozen before final benchmark/test execution",
) -> Path:
