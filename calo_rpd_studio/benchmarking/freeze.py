    ...
    *,
    ...
    payload = {
        ...
        "frozen_scope": {
            ...
            "v650_torch_newton_backtracking_cpu_parity": True,
            "v650_consistent_zero_impedance_threshold": True,
            "v650_bounded_discrete_step_generation": True,
            "v650_safe_zero_span_constraint_normalization": True,
            "v650_stable_near_zero_policy_qualification": True,
            "v650_transactional_policy_checkpoint_mutations": True,
            "v650_monotonic_checkpoint_latest_lineage": True,
            "v650_self_authenticating_atomic_exact_resume_envelope": True,
            "v650_streaming_checkpoint_hashing": True,
            "v650_broker_shutdown_failure_propagation": True,
            "v650_comparison_applies_current_gui_configuration": True,
            "v650_results_explorer_corrupt_json_safe": True,
            "v650_stage_b_equal_length_parity_gate": True,
            "v650_canonical_holdout_identity_protection": True,
            "v660_reusable_orpd_decode_workspace": True,
            "v660_unified_feasibility_tolerance_and_ordering": True,
            "v660_bounded_dense_large_case_fallbacks": True,
            "v660_lindex_dimension_identity_validation": True,
            "v660_vectorized_branch_angle_constraints": True,
            "v660_separated_training_rng_streams": True,
            "v660_nan_safe_degenerate_friedman_evidence": True,
            "v660_bounded_policy_and_static_tensor_caches": True,
            "v660_narrowed_resource_and_accelerator_error_paths": True,
            "v660_deterministic_campaign_secondary_order": True,
            "v660_semantic_key_workspace_restore": True,
            "v660_read_only_config_validation_and_strict_unknown_fields": True,
            "v660_structured_workspace_restore_failures": True,
            "v660_sparse_jacobian_failure_fallback": True,
            "v660_inactive_candidates_removed_from_batch_solve": True,
            "v660_cross_scenario_torch_batching": True,
            "v660_explicit_policy_training_completion_state": True,
            "v660_universal_resume_dispatch": True,
            "v660_stale_results_selection_safe": True,
            "v660_corrupt_portfolio_manifest_diagnostic": True,
            "v660_verified_result_count_preserved_on_stop": True,
            "v660_safe80_lazy_governor_config_parity": True,
            "v660_real_development_config_case_cache": True,
            "v660_oversized_synthetic_request_chunking": True,
            "v660_static_curriculum_tensor_lru_cache": True,
            "v670_nvml_dependency_declared": True,
            "v670_cuda_compute_independent_from_telemetry": True,
            "v670_stable_nvidia_uuid_pci_mapping": True,
            "v670_canonical_cross_runtime_device_binding": True,
            "v670_planned_vs_actual_device_attestation": True,
            "v670_nonmisleading_os_adapter_labels": True,
            "v680_calo_intelligence_independent_validation": True,
            "v680_no_cross_tab_auto_rehydration": True,
            "v680_independent_policy_qualification_template": True,
            "v680_per_accelerator_backend_repair": True,
            "v690_cuda_80_percent_process_vram_ceiling": True,
            "v690_cuda_eligible_data_plane_device_resident": True,
            "v690_cuda_oom_microbatch_retry_no_cpu_fallback": True,
            "v690_fixed_shape_masked_newton_hot_loop": True,
            "v690_single_completed_population_host_materialization": True,
            "v690_ppo_epoch_loss_single_host_materialization": True,
            "v690_ppo_cuda_minibatch_oom_backoff": True,
            "v690_vram_residency_attestation": True,
