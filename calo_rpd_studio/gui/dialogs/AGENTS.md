...
- Keep decisions concise, scientist-readable, and safe by default.
- Show validation errors before applying state and avoid partial mutation on cancellation or failure.
