...
class BenchmarkCampaignPanel(WorkspacePage):
    ...
    def __init__(self, state, experiment_manager, parent=None) -> None:
        ...
        self.freeze_path = QLineEdit(
            str(Path(__file__).resolve().parents[2] / "data" / "frozen" / "calo_v2_freeze.json")
        )
        ...
        self.output_directory = QLineEdit("benchmark_v2")
        ...
        self.package_manifest = QLineEdit("benchmark_v2/campaign_manifest.json")
    ...
    def campaign_config(self) -> BenchmarkCampaignConfig:
        return BenchmarkCampaignConfig(
            ...
            output_directory=self.output_directory.text().strip() or "benchmark_v2",
