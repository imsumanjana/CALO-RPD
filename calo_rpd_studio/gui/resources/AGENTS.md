...
# GUI resource instructions

- Keep resources deterministic, licensed, and package-safe.
- Avoid embedding generated evidence, local paths, secrets, or policy artifacts.
