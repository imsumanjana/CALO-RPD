...
- Maintain readable contrast, focus visibility, and ordinary-scientist usability.
- Theme changes must not hide warnings or encode scientific status ambiguously.
