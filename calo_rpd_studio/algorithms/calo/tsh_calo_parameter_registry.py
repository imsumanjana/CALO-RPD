...
_DEFINITIONS = (
    ...
    TSHCALOParameterDefinition(
        "environment.feasible_archive_capacity",
        "Feasible archive capacity",
        "search_environment",
        "integer",
        "discrete",
        True,
    ...
    TSHCALOParameterDefinition(
        "environment.boundary_archive_capacity",
        "Boundary archive capacity",
        "search_environment",
        "integer",
        "discrete",
        True,
    ...
    TSHCALOParameterDefinition(
        "environment.memory_capacity",
        "Success-memory capacity",
        "search_environment",
        "integer",
        "discrete",
        True,
    ...
    TSHCALOParameterDefinition(
        "environment.memory_decay",
        "Success-memory decay",
        "search_environment",
        "continuous",
        "linear",
        True,
    ...
    TSHCALOParameterDefinition(
        "environment.credit_decay",
        "Operator-credit decay",
        "search_environment",
        "continuous",
        "linear",
        True,
    ...
    TSHCALOParameterDefinition(
        "environment.credit_floor",
        "Operator-credit floor",
        "search_environment",
        "continuous",
        "log",
        True,
    ...
    TSHCALOParameterDefinition(
        "environment.group_credit_decay",
        "Group-credit decay",
        "search_environment",
        "continuous",
        "linear",
    ...
    TSHCALOParameterDefinition(
        "environment.max_learning_lane_fraction",
        "Maximum learning-lane fraction",
        "search_environment",
        "continuous",
        "linear",
        True,
    ...
    TSHCALOParameterDefinition(
        "environment.precision_start_radius",
        "Initial precision radius",
        "search_environment",
        "continuous",
        "log",
        True,
    ...
    TSHCALOParameterDefinition(
        "environment.precision_min_radius",
        "Minimum precision radius",
        "search_environment",
        "continuous",
        "log",
        True,
    ...
    TSHCALOParameterDefinition(
        "environment.precision_max_radius",
        "Maximum precision radius",
        "search_environment",
        "continuous",
        "log",
        True,
    ...
    TSHCALOParameterDefinition(
        "environment.epsilon_quantile",
        "Feasibility quantile",
        "search_environment",
        "continuous",
        "linear",
        True,
    ...
    TSHCALOParameterDefinition(
        "environment.epsilon_control_fraction",
        "Feasibility-control fraction",
        "search_environment",
        "continuous",
        "linear",
        True,
    ...
    TSHCALOParameterDefinition(
        "environment.epsilon_exponent",
        "Feasibility-control exponent",
        "search_environment",
        "continuous",
        "log",
        True,
    ...
    TSHCALOParameterDefinition(
        "environment.memory_evidence_batches",
        "Memory evidence window",
        "search_environment",
        "integer",
        "discrete",
        True,
    ...
    TSHCALOParameterDefinition(
        "environment.recovery_diversity_threshold",
        "Recovery diversity threshold",
        "search_environment",
        "continuous",
        "log",
        True,
    ...
    TSHCALOParameterDefinition(
        "environment.recovery_fraction",
        "Recovery fraction ceiling",
        "search_environment",
        "continuous",
        "linear",
        True,
    ...
    TSHCALOParameterDefinition(
        ...
        "linear",
        False,
        scientist_tunable=False,
        local_response_allowed=True,
        description="Effective attraction selected by the policy for a control group.",
    ),
    TSHCALOParameterDefinition(
        "policy.differential",
        "Policy differential influence",
        "adaptive_search_action",
        "continuous",
        "linear",
        False,
    ...
    TSHCALOParameterDefinition(
        "policy.exploration_sigma",
        "Policy exploration scale",
        "adaptive_search_action",
        "continuous",
        "linear",
        False,
    ...
    TSHCALOParameterDefinition(
        "reward.objective_weight",
        "Objective-improvement reward weight",
        "reward_definition",
        "continuous",
        "linear",
        True,
        changes_learning_objective=True,
        scientist_tunable=False,
    ),
    TSHCALOParameterDefinition(
        "reward.constraint_weight",
        "Constraint-improvement reward weight",
        "reward_definition",
        "continuous",
        "linear",
        True,
    ...
    TSHCALOParameterDefinition(
        ...
        "Diversity-recovery reward weight",
        "reward_definition",
        "continuous",
        "linear",
        True,
    ...
    TSHCALOParameterDefinition(
        "reward.overhead_weight",
        "Overhead penalty weight",
        "reward_definition",
        "continuous",
        "linear",
        True,
