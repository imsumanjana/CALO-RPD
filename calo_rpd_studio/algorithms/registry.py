...
SPECS={
'CALO':AlgorithmSpec('CALO',CALOOptimizer,'CALO v4.1 constraint-cognitive tensor-native optimizer with persistent personal memory, HPEM Best-1/3/5/7, contextual batch credit, mixed-variable group intelligence, single-budget dual-lane self-learning, partial recovery, and counted cognitive precision.',{'use_ai':True,'use_memory':True,'use_dual_archives':True,'use_epsilon':True,'use_mixed_variable':True,'use_diversity_recovery':True,'use_hpem':True,'use_contextual_credit':True,'use_variable_intelligence':True,'use_dual_lane':True,'use_cognitive_precision':True,'use_exact_evaluation_cache':True,'strict_benchmark_mode':True,'epsilon_quantile':0.75,'epsilon_control_fraction':0.65,'epsilon_exponent':2.0,'stagnation_window':12,'ai_credit_blend':0.65,'ai_policy_weight':0.35,'memory_capacity':256,'credit_decay':0.90,'precision_start_radius':0.04,'precision_min_radius':0.0005,'precision_max_radius':0.15}),
