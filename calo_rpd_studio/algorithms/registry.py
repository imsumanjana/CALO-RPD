...
SPECS = {
    "CALO": AlgorithmSpec(
        "CALO",
        CALOOptimizer,
        "CALO v5.4.1 continuation-aware constraint-cognitive tensor-native optimizer with persistent personal memory, HPEM Best-1/3/5/7, contextual batch credit, mixed-variable group intelligence, single-budget dual-lane self-learning, partial recovery, and counted cognitive precision.",
        {
            "use_ai": True,
            "strict_policy_binding": True,
            "use_memory": True,
            "use_dual_archives": True,
            "use_epsilon": True,
            "use_mixed_variable": True,
            "use_diversity_recovery": True,
            "use_hpem": True,
            "use_contextual_credit": True,
            "use_variable_intelligence": True,
            "use_dual_lane": True,
            "use_cognitive_precision": True,
            "use_exact_evaluation_cache": True,
            "strict_benchmark_mode": True,
            "epsilon_quantile": 0.75,
            "epsilon_control_fraction": 0.65,
            "epsilon_exponent": 2.0,
            "stagnation_window": 12,
            "ai_credit_blend": 0.65,
            "ai_policy_weight": 0.35,
            "memory_capacity": 256,
            "credit_decay": 0.90,
    ...
    "SA": AlgorithmSpec(
        ...
        {"temperature": 1.0, "cooling": 0.995, "step_scale": 0.1},
    ),
    "SSA": AlgorithmSpec("SSA", SalpSwarmOptimizer, "Salp Swarm Algorithm.", {}),
    "ACO": AlgorithmSpec(
        "ACO",
        AntColonyContinuousOptimizer,
        "ACOR continuous-domain Ant Colony Optimization.",
        {"q": 0.5, "xi": 0.85},
    ),
    "BA": AlgorithmSpec("BA", BatOptimizer, "Bat Algorithm.", {"loudness": 0.9, "pulse_rate": 0.5}),
    "CSA": AlgorithmSpec(
        "CSA",
        CrowSearchOptimizer,
    ...
    "FA": AlgorithmSpec(
        "FA", FireflyOptimizer, "Firefly Algorithm.", {"alpha": 0.2, "beta0": 1.0, "gamma": 1.0}
    ),
    "FPA": AlgorithmSpec(
        "FPA",
    ...
    "ICA": AlgorithmSpec(
        "ICA",
        ImperialistCompetitiveOptimizer,
