...
class PlotStyle:
    title_font:str='Times New Roman';x_label_font:str='Times New Roman';y_label_font:str='Times New Roman';x_tick_font:str='Times New Roman';y_tick_font:str='Times New Roman';legend_font:str='Times New Roman';annotation_font:str='Times New Roman'
    title_size:int=14;x_label_size:int=12;y_label_size:int=12;x_tick_size:int=10;y_tick_size:int=10;legend_size:int=10;annotation_size:int=10
    title_bold:bool=True;axis_labels_bold:bool=True;tick_labels_bold:bool=False;legend_bold:bool=False;annotations_bold:bool=False
    title_italic:bool=False;axis_labels_italic:bool=False;tick_labels_italic:bool=False;legend_italic:bool=False;annotations_italic:bool=False
